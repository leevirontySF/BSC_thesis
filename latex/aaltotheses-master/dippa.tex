...
\begin{filecontents*}{\jobname.xmpdata}
  \Title{Oikeisiin virheisiin! Virheelliset vastaukset ja niiden tulkinta automaattisesti tarkastetuissa matematiikan harjoitustehtävissä}
  \Author{Hannu Tiitu}
  \Keywords{oppimisympäristö\sep pedagoginen käytettävyys\sep virheluokittelu\sep automaattinen tarkastaminen\sep matematiikan opetus\sep Stack}
...
\makeatother
\usepackage[english,finnish]{babel}   % Kieli on suomi, abstraktissa englanti
...
\author{Hannu Tiitu}
\title{Oikeisiin virheisiin! Virheelliset vastaukset ja niiden tulkinta automaattisesti tarkastetuissa matematiikan harjoitustehtävissä}
...
{\fontsize{11.9pt}{11.9pt}\bfseries\sffamily\lsstyle Matematiikan ja operaatiotutkimuksen maisteriohjelma}
...
\begin{picture}(0,0)
\put(356,-7.8){\bfseries\sffamily\footnotesize\lsstyle DIPLOMITYÖ}
...
{\parindent0pt % Kappaleiden sisennys pois päältä
\begin{spacing}{1.1}
\hspace{-39.1mm}{\fontsize{10.5pt}{10.5pt}\sffamily\lsstyle Aalto-yliopisto}

\hspace{-39.1mm}{\fontsize{10.5pt}{10.5pt}\bfseries\sffamily\lsstyle DIPLOMITYÖ} {\sffamily\lsstyle 2017}
\end{spacing}
...
\begin{tabbing}
Valvoja:\hspace{6mm} \= professori Lauri Malmi \\
...
{\fontsize{10.5pt}{10.5pt}\bfseries\sffamily\lsstyle Työn laji}~~{\small Diplomityö}\hfill{\fontsize{10.5pt}{10.5pt}\bfseries\sffamily\lsstyle Päiväys}~~{\small 27.11.2017}\hfill{\fontsize{10.5pt}{10.5pt}\bfseries\sffamily\lsstyle Sivuja}~~{\small 70}\hfill{\fontsize{10.5pt}{10.5pt}\bfseries\sffamily\lsstyle Kieli}~~{\small suomi}
...
% Abstract page is written in English
...
\selectlanguage{finnish}  % Palataan suomeen
