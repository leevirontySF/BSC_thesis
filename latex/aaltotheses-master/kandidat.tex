...
\begin{filecontents*}{\jobname.xmpdata}
  \Title{Mot riktiga fel! Felaktiga svar och deras tolkning i automatisk rättade övningar i matematik}
  \Author{Hannu Tiitu}
  \Keywords{lärmiljö\sep pedagogiskt användbarhet\sep klassificering av fel\sep automatisk rättning\sep undervisning i matematik\sep Stack}
  \Publisher{Aalto-universitetet}
\end{filecontents*}
...
\makeatother
\usepackage[english,swedish]{babel}   % Kieli on ruotsi, abstraktissa englanti
...
\author{Hannu Tiitu}
\title{Mot riktiga fel! Felaktiga svar och deras tolkning i automatisk rättade övningar i matematik}
...
{\parindent0pt % Kappaleiden sisennys pois päältä
\begin{spacing}{1.1}
\hspace{-39.1mm}{\fontsize{10.5pt}{10.5pt}\sffamily\lsstyle Aalto-universitetet}

\hspace{-39.1mm}{\fontsize{10.5pt}{10.5pt}\bfseries\sffamily\lsstyle KANDIDATARBETET} {\sffamily\lsstyle 2017}
\end{spacing}
...
\vspace{7.8mm}{\fontsize{10.5pt}{10.5pt}\bfseries\sffamily\lsstyle Författare}\\
{\small Hannu Tiitu}
...
\noindent{\fontsize{10.5pt}{10.5pt}\bfseries\sffamily\lsstyle Sammandrag}
\vspace{.8mm}
...
\makebox[21mm][l]{\fontsize{10.5pt}{10.5pt}\bfseries\sffamily\lsstyle Nyckelord}\parbox[t]{121.6mm}{\raggedright\small lärmiljö, pedagogiskt användbarhet, klassificering av fel, automatisk rättning, undervisning i matematik, Stack}
...
\selectlanguage{swedish}  % Palataan ruotsiin
