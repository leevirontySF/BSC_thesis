...
% Vihreä kansisivu
\pagecolor{aaltoGreen}\afterpage{\nopagecolor}
{\color{black}  % Musta teksti

{\parindent0pt % Kappaleiden sisennys pois päältä
{\fontsize{11.9pt}{11.9pt}\bfseries\sffamily\lsstyle Tietotekniikan laitos}
...
\begin{picture}(0,0)
\put(356,-7.8){\bfseries\sffamily\footnotesize\lsstyle LISENSIAATIN-}
\put(356,-17.4){\bfseries\sffamily\footnotesize\lsstyle TUTKIMUS}
...
\hspace{-39.1mm}{\fontsize{10.5pt}{10.5pt}\bfseries\sffamily\lsstyle LISENSIAATINTUTKIMUS} {\sffamily\lsstyle 2017}
\end{spacing}
...
Lisensiaatintutkimus, joka on jätetty opinnäytteenä tarkastettavaksi
tekniikan lisensiaatin tutkintoa varten.

Otaniemi, 27.11.2017

\begin{tabbing}
Valvoja:\hspace{9mm} \= professori Lauri Malmi \\
Ohjaaja: \> dosentti Jarmo Malinen \\
Tarkastaja: \> professori Matti Harjula
\end{tabbing}
\vspace{-4mm}
\end{spacing}
} % fontsize
